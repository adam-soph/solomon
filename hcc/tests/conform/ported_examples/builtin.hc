...
// would be only "whatever the host libm does," with no portable hcc
...
#include <stdlib.hh>
#include <string.hh>
#include <string.hh>  // StrLen/StrCmp/StrCpy/StrCat + MemCpy/MemSet/MemCmp
#include <ctype.hh>   // ToUpper
#include <math.hh>    // Sqrt
