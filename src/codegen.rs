...
//! the CPU. Two implement the trait: [`arm64_darwin`] (Mach-O, links via `cc`;
//! `aarch64-apple-darwin`) and [`x86_64_linux`] (a freestanding static ELF with
//! raw Linux syscalls; `x86_64-unknown-linux`). (The tree-walking
