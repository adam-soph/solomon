...
union _F64Bits { F64 f; U64 u; }

I64 Float64bits(F64 x)     { _F64Bits v; v.f = x; return v.u; }
F64 Float64frombits(I64 b) { _F64Bits v; v.u = b; return v.f; }

F64 NaN()                  { _F64Bits v; v.u = 0x7FF8000000000000; return v.f; }
F64 Inf(I64 sign)          { _F64Bits v; if (sign >= 0) v.u = 0x7FF0000000000000; else v.u = 0xFFF0000000000000; return v.f; }

I64 IsNaN(F64 x)           { return x != x; }
I64 Signbit(F64 x)         { _F64Bits v; v.f = x; return (v.u >> 63) & 1; }
